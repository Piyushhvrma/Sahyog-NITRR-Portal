    ...
    <div className="about-page-container">
      ...
      <header className="about-hero">
        <div className="about-hero-content">
          ...
          <p>
            Discover the journey and vision behind SAHYOG - The Student
            Wellbeing Club.
          </p>
        </div>
      </header>
      ...
      <main className="container about-container">
        ...
        <section className="about-section">
          ...
          <p>
            ...
            navigate the exciting yet challenging waters of college
        ...
        <section className="about-section faculty-section">
          ...
          <div className="faculty-grid">
            ...
            <div className="faculty-card">
              <img src={facultyPhoto1} alt="Dr. A.K. Dash" />{" "}
              {/* Uses imported image */}
              <h3>
                {/* Name is now a clickable link */}
                <a
                  href="https://nitrr.ac.in/viewdetails.php?q=min.akdash"
                  target="_blank"
              ...
              <blockquote>
                "Sahyog represents the spirit of collaborative growth that we
                cherish at our institution. It's inspiring to see students
                uplift one another."
              </blockquote>
            </div>
            ...
            <div className="faculty-card">
              <img src={facultyPhoto2} alt="Dr. Madhukrishna Priyadarsini" />{" "}
              {/* Uses imported image */}
              <h3>
                {/* Name is now a clickable link */}
                <a
                  href="https://nitrr.ac.in/viewdetails.php?q=cse.mpriyadarsini"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="faculty-link"
                >
              ...
              <blockquote>
                "Mentorship is key to unlocking a student's full potential.
                Sahyog provides the perfect platform for this transformative
                journey."
              </blockquote>
            </div>
          </div>
        ...
        <section className="about-section activities-section">
          ...
          <div className="about-activities-grid">
            <div className="activity-card">
              ...
              <p>
                From focused remedial sessions to our innovative{" "}
                <strong>Green Library</strong> for sharing study resources, we
            ...
            <div className="activity-card">
              ...
              <p>
                Our acclaimed <strong>Mock Placement Sessions</strong> and
                insightful <strong>Career Guidance Talks</strong> empower
                students to face interviews and professional life with
                confidence.
              </p>
            </div>
            <div className="activity-card">
              ...
              <p>
                Annual events like the large-scale{" "}
                <strong>Blood Donation Camp</strong>, in collaboration with{" "}
                <strong>AIIMS Raipur</strong>, unite our community under a
                single cause: growth with compassion.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="about-section motto-section">
          ...
          <p>
            This isn't just our motto; it's our promise. We believe in
            transforming the NIT Raipur campus into a true community of care and
            collaboration.
            <br />
            <br />
            सच में, ये सिर्फ़ एक क्लब नहीं, बल्कि एक <strong>
              परिवार है
            </strong>{" "}
            — where every student finds guidance, friendship, and the courage to
            move forward.
          </p>
        </section>
      </main>
